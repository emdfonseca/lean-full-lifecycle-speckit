...
metrics:
  ...
  duplicate_backlog_rate:
    value: not_applicable
    why: No backlog item was created in the pilot project.
  convergence_findings:
    value: not_applicable
    why: No converge step runs in this stream; no spec exists to diverge from.
  ready_to_output_done_hours:
    value: not_applicable
    why: No item was delivered in the pilot project.
